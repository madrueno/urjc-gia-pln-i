...
Ejercicios de Transformers, abarcando desde la construcción de arquitecturas encoder y decoder desde cero con Keras hasta fine-tuning de modelos preentrenados (BERT) y obtención de embeddings contextuales.
...
- **05_02_finetuning**: Fine-tuning de modelos preentrenados (BERT, DistilBERT, ALBERT, XLM-RoBERTa) para clasificación de sentimiento.

- **05_03_sbert**: Embeddings contextuales con BERT y Sentence-BERT (pooling, similitud, comparación con Word2Vec).
